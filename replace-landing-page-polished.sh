      ...
      <div className="relative max-w-7xl mx-auto px-6 py-36 flex flex-col md:flex-row items-center gap-20">
        <div className="flex-1 space-y-8 z-10">
          ...
          <div className="flex gap-4 mt-6">
            <button className="bg-gradient-to-r from-blue-500 to-green-500 text-white font-semibold px-8 py-4 rounded-lg shadow-md hover:shadow-xl transition-all duration-500">
              Start Free Session
            </button>
        ...
        <div className="flex-1 relative w-full h-96 md:h-[34rem] rounded-xl overflow-hidden shadow-lg transform hover:scale-105 transition-transform">
...
export default function FeaturesSection() {
  return (
    <section className="max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-3 gap-8 bg-gray-50 rounded-xl shadow-lg border border-gray-200">
      <div className="bg-white rounded-xl p-6 flex flex-col items-center text-center shadow-md hover:scale-105 transition-transform">
...
export default function CTASection() {
  return (
    <section className="bg-white py-28 text-center rounded-xl shadow-md border border-gray-200 mt-16">
...
export default function Footer() {
  return (
    <footer className="bg-white py-20 md:py-24 text-gray-700 text-center text-sm rounded-t-xl border-t border-gray-200 mt-16">
      <p className="mb-6">© 2026 MyVirtualTutor. Math tutoring for grades 6–12.</p>
...
echo "Polished landing page layout restored!"
